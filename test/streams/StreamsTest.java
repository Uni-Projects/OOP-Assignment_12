...
public class StreamsTest {
    ...
    static final Integer[] PI = {3,1,4,1,5,9,2,6,5,3,5,8,9,7,9,3,2,3,8,4,6,2,6,4,3,3,8,3,2,7,9,5,0,2,8,8,4,1,9,7,1,6,9,3,9,9,3,7,5,1,0};
    ...
    public void everySecondElement() {
        // Use streams and an anonymous inner class to remove every second element from the list
    ...
    // Perform rot13 encoding on an integer representing a character code point.
    // All letters [a-zA-Z] are rotated by 13 places.
    // All other characters are left unchanged.
    static int rot13(int x) {
        if( x >= 'a' && x <= 'z') {
            x = x - 'a';
            return ((x + 13) % 26) + 'a';
        }
